...
<template>
  ...
  <footer class="footer">
    <MySection :id sectionName="Une envie ?" backgroundColor="#f15a52" textColor="#000" class="footer__envie">
      <div class="content">
        <p>
          Vous avez un projet en tête ? Vous souhaitez en discuter ? N'hésitez
          pas à me contacter pour en discuter.
        </p>
        <MyBtn class="btn" variant="third" color="#000" href="/contact">Me contacter</MyBtn>
      </div>
    </MySection>
    <MySection :id="`0${Number(id) + 1}`" sectionName="Footer" backgroundColor="#e3d7c0" textColor="#000"
      ...
      <div class="footer__socials">
        <NuxtLink to="https://github.com/QuentinHeinis" externals target="_blank">
          <svg width="1024" height="1024" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
              ...
              transform="scale(64)" fill="#f15a52" />
          </svg>
        </NuxtLink>
        <NuxtLink to="https://instagram.com/studio_heinis" externals target="_blank">
          <svg fill="#f15a52" width="800px" height="800px" viewBox="0 0 19.2 19.2" data-name="Instagram w/circle"
        ...
        <NuxtLink to="https://fr.linkedin.com/in/quentin-heinis-731ab8223" externals target="_blank">
          <svg height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 291.319 291.319" xml:space="preserve">
            <g>
              <path style="fill: #f15a52"
