...
<template>
  <div class="about">
    ...
    <div class="about__txt">
      <p>
        Bonjour, <br />je suis Quentin, un développeur fullstack passionné de 22
        ans. Diplômé d'un BUT Métiers du Multimédia et de l'Internet, j'ai
        acquis une expérience précieuse en alternance en tant que développeur
        web, travaillant à la fois sur des projets internes pour une entreprise
        et en agence pour divers clients.
      </p>
      <p>
